          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center py-8 md:py-14 lg:py-20 border-t border-base-300">
            ...
            >
              ...
              <div className="space-y-6 font-medium text-base-content/70">
                <p>
                  Our journey began with a simple belief: manufacturing should
                  be transparent. Today, we handle millions of units annually
                  while maintaining the artisan touch in every stitch.
                </p>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="pt-6">
                    <p className="text-sm font-medium leading-relaxed italic">
                      "We don't just follow trends; we set the infrastructure
                      that makes trends possible."
                    </p>
                  </div>
                </div>
              </div>
